...
> **⚠️ Current Version**: v0.9.4 beta. Please report any issues or feedback at [GitHub Issues](https://github.com/ksmksks/obs-scene-switcher/issues).
...
1. Download [obs-scene-switcher-0.9.4-installer.exe](https://github.com/ksmksks/obs-scene-switcher/releases/latest) from the latest release
...
1. Download [obs-scene-switcher-0.9.4-manual.zip](https://github.com/ksmksks/obs-scene-switcher/releases/latest) from the latest release
...
- **HTTP 429 "Too Many Requests" errors**: Fixed in v0.9.4 with exponential backoff
  - If you see repeated connection/disconnection in logs, update to v0.9.4 or later
...
- v0.9.4 (2026-03-27): Manual scene revert button + WebSocket reconnection fix
- v0.9.3 (2026-01-15): Authentication error feedback improvement
- v0.9.2 (2026-01-07): Critical bug fix for scene selection preservation
- v0.9.1 (2026-01-07): Bug fixes and streaming sync feature
- v0.9.0 (2026-01-07): Initial beta release
