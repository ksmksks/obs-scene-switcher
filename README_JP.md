...
> **⚠️ 現在のバージョン**: v0.9.4 ベータ版です。不具合やフィードバックは [GitHub Issues](https://github.com/ksmksks/obs-scene-switcher/issues) までお願いします。
...
1. 最新リリースから [obs-scene-switcher-0.9.4-installer.exe](https://github.com/ksmksks/obs-scene-switcher/releases/latest) をダウンロード
2. 管理者としてインストーラーを実行
3. インストールウィザードに従う
...
1. 最新リリースから [obs-scene-switcher-0.9.4-manual.zip](https://github.com/ksmksks/obs-scene-switcher/releases/latest) をダウンロード
2. ZIP ファイルを展開
...
- **HTTP 429 「Too Many Requests」エラー**: v0.9.4で指数バックオフにより修正済み
  - ログで接続/切断が繰り返される場合は、v0.9.4以降にアップデートしてください
...
- v0.9.4 (2026-03-27): 手動シーン戻しボタン + WebSocket再接続修正
- v0.9.3 (2026-01-15): 認証エラーフィードバックの改善
- v0.9.2 (2026-01-07): シーン選択保持の重大なバグ修正
- v0.9.1 (2026-01-07): バグ修正と配信連動機能
- v0.9.0 (2026-01-07): 初回ベータリリース
